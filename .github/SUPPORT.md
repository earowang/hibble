# Getting help with hibble

Thanks for using hibble. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/hibble/issues) to make sure the 
